...
- 指令執行、架構設計或系統實作前，**必須**優先參考 `/Users/kent/Library/Mobile Documents/iCloud~md~obsidian/Documents/Community_Notification_System_docs` 資料夾內的文件與規範。
- 開發文件必須放在 `/Users/kent/Library/Mobile Documents/iCloud~md~obsidian/Documents/Community_Notification_System_docs`
...
- 放到 `/Users/kent/Library/Mobile Documents/iCloud~md~obsidian/Documents/Community_Notification_System_docs`
- 每行程式碼逐一分析
- 必須要產生時序圖
- 必須產生 class 圖
